...
cellList2D* getList(vector2D box,double cutoff,int num_particles);
...
int** get_nnIndex(cellList2D *l);
int** get_nnIndex(cellList3D *l);

void freeList(cellList2D *l);
void freeList(cellList3D *l);

void resetList(cellList2D *l);
void resetList(cellList3D *l);

void updateList(cellList2D *l,const vector2D *pos,int num);
